        ...
        body: Column(
          ...
          children: <Widget>[
            FlatButton(color:Colors.lightBlue,
                onPressed: () => Navigator.pop(context),
                child: Text('Go Back')),
            Image.asset('assets/illinois.jpg'),
        ...
        body: Column(
          ...
          children: <Widget>[
            FlatButton(color:Colors.lightBlue,
                onPressed: () => Navigator.pop(context),
                child: Text('Go Back')),
            Image.asset('assets/cambridge.jpg'),
